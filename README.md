...
*   DL그룹 부동산 자산 Asset Management 업무 수행(디타워, 글래드 호텔 등)
*   부동산 자산 및 입점 매장 성장을 위한 가설 설정 및 분석에 따른 비즈니스 방향성 제안
*   입점 매장 매출 및 외부 데이터 기반 상권 패턴 및 오프라인 소비 트렌드 분석
*   Data Mart, Power BI 대시보드 설계 및 운영, 전사 단위의 정기적 리포팅 및 의사결정 지원

* DL그룹 부동산 자산 Asset Management 업무 수행
부동산 자산, 입점 매장 성장을 위한 가설 설정과 비즈니스 방향성 제안 및 의사결정 지원
입점 매장 매출 및 외부 데이터 기반 상권 패턴 및 오프라인 소비 트렌드 분석
Data Mart 구축을 위한 다차원 모델 설계 및 KPI 대시보드 운영
리뷰 텍스트 기반 감성 분석 및 매출 수익 예측 모델 설계 및 유지 관리
